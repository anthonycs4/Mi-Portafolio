      ...
      <div className="relative z-10 w-full max-w-[600px] px-8">
        ...
        >
          ...
          <div className="p-8 pb-6 text-center border-b border-glass-border">
            <h2
              className={`mb-3 ${isGlitching ? 'glitch-text' : ''}`}
          ...
          <div className="p-8 space-y-3">
            {contactMethods.map((method) => (
              <a
                ...
                className="group relative block w-full p-4 rounded-xl bg-glass-hover border border-glass-border transition-all duration-300 hover:border-opacity-50 hover:-translate-y-1"
                style={{
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className="w-12 h-12 rounded-lg flex items-center justify-center text-text-secondary group-hover:text-white transition-colors duration-300"
                    style={{
                  ...
                  <svg
                    className="w-5 h-5 ml-auto text-text-tertiary group-hover:text-white transition-all duration-300 group-hover:translate-x-1"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="text-sm text-text-secondary font-mono">
              Built with <span className="text-neon-cyan">React</span> + <span className="text-neon-purple">Tailwind CSS</span>
            </p>
            <p className="text-xs text-text-tertiary mt-1">
              Deployed on <span className="text-text-secondary">Vercel</span> • © 2024
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-glass-hover border border-glass-border flex items-center justify-center text-text-tertiary transition-all duration-300 hover:text-white hover:border-opacity-50"
                style={{
                  borderColor: 'rgba(255, 255, 255, 0.1)',
                }}
                onMouseEnter={(e) => {
